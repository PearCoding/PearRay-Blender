...
def register():
    bpy.utils.register_class(PearRayLightProperties)
    bpy.types.Light.pearray = PointerProperty(type=PearRayLightProperties)


def unregister():
    del bpy.types.Light.pearray
    bpy.utils.unregister_class(PearRayLightProperties)
