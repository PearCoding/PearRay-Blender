...
def register():
    bpy.utils.register_class(PearRayMaterialProperties)

    bpy.types.Material.pearray = PointerProperty(
        type=PearRayMaterialProperties)


def unregister():
    del bpy.types.Material.pearray

    bpy.utils.unregister_class(PearRayMaterialProperties)
